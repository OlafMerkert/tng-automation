 ...
 */
// Select (SPI) CC1101
#define cc1101_Select()  digitalWrite(ssPin, LOW)
// Deselect (SPI) CC1101
#define cc1101_Deselect()  digitalWrite(ssPin, HIGH)
// Wait until SPI MISO line goes low
#define wait_Miso()  while(digitalRead(MISO)>0)
// Get GDO0 pin state
#define getGDO0state()  digitalRead(this->gd0pin)
 ...
 * Class constructor
 */
CC1101::CC1101(uint8_t slaveSelect, uint8_t gd0)
{
...
void CC1101::init(uint8_t freq, uint8_t mode)
{
  ...
  pinMode(this->gd0pin, INPUT);                 // Config GDO0 as input
